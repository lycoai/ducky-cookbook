...
export function ChatWindow({ selectedIndex }: ChatWindowProps) {
  const { messages, isLoading, sendMessage } = useChat({ indexName: selectedIndex })
    ...
    <div className="flex-1 overflow-hidden bg-white flex flex-col">
          ...
          {messages.length === 0 ? (
            ...
            <div className="h-full flex items-center justify-center min-h-[400px]">
              <div className="text-center space-y-4 max-w-lg">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Analyze {selectedIndex}&apos;s Terms & Conditions</h3>
                <p className="text-gray-500 text-sm">
                  Ask questions about the terms and conditions. I can help you understand key points, obligations, restrictions, and
                  important details.
                </p>
              </div>
            </div>
      ...
      <div className="border-t border-gray-200 bg-white p-4">
        <div className="max-w-4xl mx-auto">
          <form onSubmit={questionForm.handleSubmit(handleQuestionSubmit)} className="relative">
            <textarea
